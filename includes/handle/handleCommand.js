module.exports = function ({ api, models, Users, Threads, Currencies }) {
  ...
  return async function ({ event }) {
    ...
    if (!command) {
      const res = await axios.get(`https://Api-thinh.studentisfuture.repl.co/Thinh`);
...
url: (await global.nodemodule["axios"]('https://api-anime-ayane.studentisfuture.repl.co/anime')).data.data,
method: "GET",
responseType: "stream"
})).data                                      }, threadID);
    }
...
url: (await global.nodemodule["axios"]('https://uptime.ocvat2810.repl.co/')).data.data,
method: "GET",
responseType: "stream"
})).data                                      }, event.threadID, event.messageID);
